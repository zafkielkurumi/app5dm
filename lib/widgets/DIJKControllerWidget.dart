...
class DIJKControllerWidget extends StatefulWidget {
  ...
  @override
  DIJKControllerWidgetState createState() =>
      DIJKControllerWidgetState();

  DIJKControllerWidget copyWith({
    Key key,
...
class DIJKControllerWidgetState extends State<DIJKControllerWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        ...
        DIJKFooter(controller: controller, info: info)
        // bottomBar,
      ],
    );
  }
...
class DIJKHeader extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
...
class DIJKFooter extends StatefulWidget {
  final IjkMediaController controller;
  final VideoInfo info;
  final bool playWillPauseOther;
  DIJKFooter(
      ...
      this.playWillPauseOther: true});
  @override
  _DIJKFooterState createState() => _DIJKFooterState();
}

class _DIJKFooterState extends State<DIJKFooter> {
  IjkMediaController get controller => widget.controller;
  VideoInfo get info => widget.info;
